...
- 세션 시작 후 작업 주제가 확인되면 먼저 `AGENTS.md` 섹션 1의 작업 유형별 진입 맵을 다시 열어 관련 계약 문서, 파일, QA 명령어를 특정한다.
...
- `UX 위험 집중 구역`에 들어갈 때는 해당 섹션을 다시 열고, Template A의 `UX 영향` 필드에 사용성·접근성·반응성·성능·디자인 일관성 중 해당 항목을 적은 뒤 승인을 받는다.
