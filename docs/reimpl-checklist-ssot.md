...
- [x] Enforce theme coverage on Landing/Test/Blog/History with locale/viewport boundary-exhaustive layout matrix plus CTA/destination/settings/mobile state-exhaustive light/dark quality gate, all sourced from the theme-matrix manifest (`§6.9`, `§14.3-8`).
