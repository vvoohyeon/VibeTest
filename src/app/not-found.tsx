...
export default function NotFound() {
  return (
    <main className={notFoundMainClassName}>
      <section className={notFoundPanelClassName}>
        <div className={notFoundEmptyClassName}>
          ...
          <h1 className={notFoundTitleClassName}>Segment Not Found</h1>
          <p className={notFoundBodyClassName}>This route exists, but the requested resource could not be found.</p>
